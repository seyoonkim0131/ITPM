        ...
        <div class="content-div">
			<div class="small-title">
		        ...
		        <div class="content-board">
		        	<div class="table_list">
		        		<ul>
			        		<c:choose>
			        			...
			        			<c:otherwise>
			        				<c:forEach items="${requestScope.ruleList}" var="result">
					        			<li>
					        				<div class="top_area">
					        					<div class="write_num">
				        					...
				        					<div class="subject">
				        						<a href="getRuleDetail.do?no=${result.no}">${result.title}</a>
				        					</div>
					        			</li>
			        				</c:forEach>
			        			</c:otherwise>
		        	...
		        	<form action="goInsertRule.do" method="post" id="goInsert"></form>
		        	<c:choose>
