    ...
    <body>
        ...
        <div class="container" id="side_menu">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="inactive">
                    <a href="getAllScheduleList.do">학사일정</a>
                </li>
                <li class="inactive">
            ...
            <div class="small-title">
                <p>
                    ...
                    <span class="small-title-right">
                        <small>
                            <a href="welcome.do">홈</a> > 학사정보 > 규정 > 학과내규 > 글쓰기</small>
                    </span>
                </p>
            </div>
            <div class="content-board">
            <form action="updateRule.do" method="post" id="updateform" enctype="multipart/form-data">
            <input type="hidden" id="updateId" name="updateId" value="${loginSession.studentId}"/>
            <input type="hidden" id="no" name="no" value="${requestScope.rule.no}"/>
            <input type="hidden" id="file1" name="file1" value="${requestScope.rule.file1}"/>
                <table class="table">    	
                    	<tr>
                            <th>제목:</th>
                            <td >
                            	<input type="text" id="title" name="title" class="form-control" value="${requestScope.rule.title}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>내용:</th>
                            <td>
                            	<textarea style="resize:none;"cols="8" rows="15" id="body" name="body" class="form-control">${requestScope.rule.body}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <th>첨부파일</th>
                        ...
                        <tr>
							...
							<td>
							<c:choose>
								<c:when test="${requestScope.rule.point eq 'Y' }">
