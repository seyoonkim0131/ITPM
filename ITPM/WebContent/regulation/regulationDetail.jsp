            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li onclick="submenu()">
                	...
                	<ul id="hide" style="display: block;">
                		<li class="inactive"><a href="http://rule.ssu.ac.kr/lmxsrv/law/lawFullView.srv?SEQ=23" target="_blank" style="color: gray;">학칙</a></li>
                		<li class="inactive"><a href="http://rule.ssu.ac.kr/lmxsrv/law/lawFullView.srv?SEQ=25" target="_blank" style="color: gray;">시행세칙</a></li>
                		<li class="active"><a href="../regulation/regulation.jsp" style="color: #b31b1b;">학과내규</a></li>
                		<li class="inactive"><a href="http://grad.ssu.ac.kr/web/grad/paper_f" target="_blank" style="color: gray;">논문심사기준</a></li>
                	</ul>
                </li>
									...
									<td colspan="2" class="text-content">
										<div>
											<div class="form-group">
												<div class="regulation col-lg-12">
...
③기타 재원에 대한 사안은 IT정책경영학과 운영위원회의 결정에 따른다.
				...
				<div class="forenext">
					<dl>
						<dt class="nextview">다음글</dt>
						<dd><a href="#">2016년 IT정책경영학과 학과내규</a></dd>
					</dl>
					<dl style="list-style: none; position: relative; margin: 10px 0!important;">
						<dt class="foreview">이전글</dt>
						<dd><a href="#">2015년 IT정책경영학과 학과내규</a></dd>
					</dl>
				</div>
	    	</div>
		</div>
