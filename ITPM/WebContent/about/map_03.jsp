    ...
    <head>
        ...
        <style type="text/css">
			...
			@media only screen and (max-width: 415px) { 
				...
				#car_image{margin-left:-5px; max-width:110%}
				#car_text{display:none;}
			}
	
			@media only screen and (min-width: 416px) and (max-width: 767px) { 
				/* #nav_tab{display:block;} */
				#car_image{max-width:80%;}
				#car_text{display:block; max-width:80%; margin:0 0 0 6%;}
			}

			/* 중간 기기들 (데스크탑, 992px 이상) */
			@media only screen and (min-width: 768px) and (max-width: 1020px) {
				/* #nav_tab{display:block;} */
				#car_image{max-width:70%;}
				#car_text{display:block; max-width:70%; margin:0 0 0 11%;}
			}
	        ...
	        <div class="content">
				...
				<ul id="nav_tab" class="nav nav-tabs">
	    			...
	    			<li><a href="map_02.jsp">버스</a></li>
	   				<li class="active"><a href="map_03.jsp">자가용</a></li>
