    ...
    <c:import url="../import/header.jsp" />
       <div
            ...
            <ul class="nav nav-pills nav-stacked" style="float:center;">
                ...
                <li class="active">
                    <a href="#" style="color:#b31b1b; background-color:transparent;">교육비전</a>
                </li>
                <li>
        ...
        <div class="small-title" style="margin: 0 0 10px 0; width:80%;">
            <p>
                <span>교수소개</span>
        ...
        <div class="content" style=" margin: 70px 0 60px 0; width:80%;">
