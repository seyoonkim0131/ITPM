		...
		<div class="content-div" >
	        <div class="small-title">
	            <p>
	                ...
	                <span class="small-title-right"><small><a href="welcome.do">홈</a> > 대학원소개 > 학과소개</small></span>
	            </p>
	        </div>
	        <div class="content-board">
				<ul class="about-list" id="itpm_list">
	        		...
	        		<li>대학원 IT정책경영학과는 시대적으로 국가사회가 요구하는 전문인력은 단순한 IT의 기술을 넘어 서비스, 과학, 경영, 공학(SSME)의 다중학문<br/>(Interdisciplinary or Multidisciplinary)을 전공한 다중학문의 IT리더십을 양성한다.</li>
