		...
		<div class="content-div">
			...
			<div class="content">
				<form action="updateNotice.do" method="post" id="updateForm" name="updateForm" enctype="multipart/form-data">
					...
					<input type="hidden" name="file1" id="file1" value="${requestScope.updateNotice.file1}"/>
					<input type="hidden" name="file2" id="file2" value="${requestScope.updateNotice.file2}"/>
					<input type="hidden" name="file3" id="file3" value="${requestScope.updateNotice.file3}"/>
					<table class="table">
						<tr>
							<th>제목</th>
