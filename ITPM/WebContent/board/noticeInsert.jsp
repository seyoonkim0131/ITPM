	...
	<body>
		...
		<div class="content-div">
			...
			<div class="content-board">
				<form action="insertNotice.do" method="post" id="insertForm" name="insertForm" enctype="multipart/form-data">
					<input type="hidden" name="createId" id="createId" value="${loginSession.studentId}"/>
					<table class="table" style="border-top: solid 2px #b31b1b;">
						<tr>
							<th>제목</th>
